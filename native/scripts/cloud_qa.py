...
def run():
    ...
    adb('install','--no-incremental','-r',OUT/'conversation-lens-0.17.0-cloud-debug.apk')
    ...
    (OUT/'cloud-ui-receipt.json').write_text(json.dumps({'synthetic':True,'passed':['login','streamer-profile-save','streamer-profile-applied','person-create','memory-create','analyze','edit','confirm-insert','restart-login','memory-edit','person-delete'],'realPhone':False,'realModel':False},indent=2),encoding='utf-8')
