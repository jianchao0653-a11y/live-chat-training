...
export const CONTEXT_VERSION = 'pair-context-v2';
...
export function packContext(person, text, goal, situation) {
  ...
  return { context, metrics:observed.metrics, learning,
    receipt:{ version:CONTEXT_VERSION, pair_id:person.relationship?.id || null, streamer_id:person.streamer?.id || null,
      ...
      strategy_outcome_ids:[...new Set((person.strategy_observations || []).filter(o=>
        o.goal===goal && o.situation===situation && context.strategy_learning.some(s=>s.strategy===o.strategy)
      ).map(o=>o.analysis_id))],
